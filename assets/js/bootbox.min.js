...
!function(t, e) {
    ...
    l = (i = ['toString', 'toLocaleString', 'valueOf', 'hasOwnProperty', 'isPrototypeOf', 'propertyIsEnumerable', 'constructor']).length,
    function(t) {
    ...
    function c(t, e, o) {
        return p.extend(!0, {}, t, function(t, e) {
            ...
            return 2 === o || 'string' == typeof t[0] ? (a[e[0]] = t[0],
            a[e[1]] = t[1]) : a = t[0],
            a
        }(e, o))
    }
    function h(t, e, o, a) {
        ...
        v(n.buttons, function(t) {
            if (l[t] === u)
                throw new Error('button key "' + t + '" is not allowed (options are ' + i.join(' ') + ')')
        }),
        n
    }
    function w(t) {
    ...
    function x(t) {
        t.target === t.data.dialog[0] && (t.data.dialog.off('escape.close.bb'),
        t.data.dialog.off('click'))
    }
    function k(t, e, o) {
        t.stopPropagation(),
        t.preventDefault(),
    ...
    d.dialog = function(t) {
        ...
        if (t = function(r) {
            ...
            v(n, function(t, e, o) {
                ...
                !e.className) {
                    ...
                    e.className = i <= 2 && a ? 'btn-primary' : 'btn-secondary btn-default'
                }
            }),
            r
        }(t),
        ...
        if (r.find('.bootbox-body').html(t.message),
        0 < w(t.buttons) && (v(l, function(t, e) {
            var o = p(f.button);
            switch (o.data('bb-handler', t),
        ...
        if (t.scrollable && (a.addClass('modal-dialog-scrollable'),
    ...
    d.alert = function() {
        var t;
        if ((t = h('alert', ['ok'], ['message', 'callback'], arguments)).callback && !p.isFunction(t.callback))
    ...
    d.prompt = function() {
        var r, e, t, n, o, a;
        if (t = p(f.form),
        (r = h('prompt', ['cancel', 'confirm'], ['title', 'callback'], arguments)).value || (r.value = m.value),
        ...
        r.buttons.confirm.callback = function() {
            ...
            if ('checkbox' === r.inputType)
                t = n.find('input:checked').map(function() {
                    return p(this).val()
                }).get();
        ...
        if (!f.inputs[r.inputType])
            throw new Error('Invalid prompt type');
        switch (n = p(f.inputs[r.inputType]),
        r.inputType) {
        case 'text':
        case 'textarea':
        case 'email':
        ...
        case 'range':
            ...
            !function(t, e, o) {
                ...
                return a
            }(r.inputType, r.min, r.max) || (r.min !== u && n.attr('min', r.min),
        ...
        case 'select':
            ...
            v(a, function(t, e) {
                ...
                o = i[e.group]);
                var a = p(f.option);
                a.attr('value', e.value).text(e.text),
                o.append(a)
            }),
            v(i, function(t, e) {
                n.append(e)
        ...
        case 'radio':
            ...
            v(a, function(t, e) {
                ...
                o.find('label').append('\n' + e.text),
                r.value !== u && e.value === r.value && (o.find('input').prop('checked', !0),
                s = !1),
                n.append(o)
            }),
        ...
        '' !== p.trim(r.message)) {
            ...
            r.message = t;
        return (e = d.dialog(r)).off('shown.bs.modal', g),
